 ...
 return (<> 
     ...
     <div className="conteiner-layout-list">
        ...
        <div className='banner-conteiner'>
           <img className='banner-logo' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSD04MUE2mAfjQ0js3AnK3ncH1el7DcuRiKiA&usqp=CAU" />
       
           <p><h2 className="banner">{listOne.name}</h2> lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem </p>
        </div>
        
        <div className='List-names'>
            
          {cards.map(objeto=>(<div className='conteiner-name'> <> 
          <div><img src={objeto.photo}/></div>
          <h3>{objeto.title}</h3>
          <h3>{objeto.genre}</h3> 
